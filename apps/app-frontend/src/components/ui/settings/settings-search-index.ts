...
export const settingsSearchEntries: SettingsSearchEntry[] = [
	...
	},
	{
		...
		categoryId: 'shortcut-settings',
		targetId: 'settings-target-shortcuts-nav-shortcutNavHome',
		label: message('app.shortcut-settings.nav-home', 'Home'),
		description: message('app.shortcut-settings.nav-home-description', 'Ctrl/Cmd + 1'),
	},
	{
		id: 'shortcuts-nav-worlds',
		categoryId: 'shortcut-settings',
		targetId: 'settings-target-shortcuts-nav-shortcutNavWorlds',
		label: message('app.shortcut-settings.nav-worlds', 'Worlds'),
		description: message('app.shortcut-settings.nav-worlds-description', 'Ctrl/Cmd + 2'),
	},
	{
		id: 'shortcuts-nav-discover',
		categoryId: 'shortcut-settings',
		targetId: 'settings-target-shortcuts-nav-shortcutNavDiscover',
		label: message('app.shortcut-settings.nav-discover', 'Discover content'),
		description: message('app.shortcut-settings.nav-discover-description', 'Ctrl/Cmd + 3'),
	},
	{
		id: 'shortcuts-nav-skins',
		categoryId: 'shortcut-settings',
		targetId: 'settings-target-shortcuts-nav-shortcutNavSkins',
		label: message('app.shortcut-settings.nav-skins', 'Skin selector'),
		description: message('app.shortcut-settings.nav-skins-description', 'Ctrl/Cmd + 4'),
	},
	{
		id: 'shortcuts-nav-multiplayer',
		categoryId: 'shortcut-settings',
		targetId: 'settings-target-shortcuts-nav-shortcutNavMultiplayer',
		label: message('app.shortcut-settings.nav-multiplayer', 'Multiplayer'),
		description: message('app.shortcut-settings.nav-multiplayer-description', 'Ctrl/Cmd + 5'),
	},
	{
		id: 'shortcuts-nav-library',
		categoryId: 'shortcut-settings',
		targetId: 'settings-target-shortcuts-nav-shortcutNavLibrary',
		label: message('app.shortcut-settings.nav-library', 'Library'),
		description: message('app.shortcut-settings.nav-library-description', 'Ctrl/Cmd + 6'),
	},
	{
		id: 'shortcuts-nav-lab',
		categoryId: 'shortcut-settings',
		targetId: 'settings-target-shortcuts-nav-shortcutNavLab',
		label: message('app.shortcut-settings.nav-lab', 'Lab'),
		description: message('app.shortcut-settings.nav-lab-description', 'Ctrl/Cmd + 7'),
	},
	{
		id: 'shortcuts-nav-downloads',
		categoryId: 'shortcut-settings',
		targetId: 'settings-target-shortcuts-nav-shortcutNavDownloads',
		label: message('app.shortcut-settings.nav-downloads', 'Downloads'),
		description: message('app.shortcut-settings.nav-downloads-description', 'Ctrl/Cmd + 8'),
	},
	{
		id: 'shortcuts-nav-create',
		categoryId: 'shortcut-settings',
		targetId: 'settings-target-shortcuts-nav-shortcutNavCreate',
		label: message('app.shortcut-settings.nav-create', 'Create new instance'),
		description: message('app.shortcut-settings.nav-create-description', 'Ctrl/Cmd + 9'),
	},
	{
		id: 'shortcuts-nav-settings',
		categoryId: 'shortcut-settings',
		targetId: 'settings-target-shortcuts-nav-shortcutNavSettings',
		label: message('app.shortcut-settings.nav-settings', 'Settings'),
		description: message('app.shortcut-settings.nav-settings-description', 'Ctrl/Cmd + ,'),
	},
	{
